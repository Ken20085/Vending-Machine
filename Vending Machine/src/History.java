...
public class History{
    ...
    private ArrayList<String> transactions;   //array to hold string messages that describe what evet occured
     ...
     * @param itemPrice cose of the item
    ...
    /**
     * clear sthe ledger when a restock is performed or a pricing change
     * @param currentItems
     */
